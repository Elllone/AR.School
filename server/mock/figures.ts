...
export const figures: Figure[] = [
  {
    ...
    description:
      'Квадра́т (от лат. quadratus, четырёхугольный) — правильный четырёхугольник, то есть плоский четырёхугольник, у которого все углы и все стороны равны. Каждый угол квадрата — прямой(90°).',
  },
  {
    slug: 'circle',
    name: 'Круг',
